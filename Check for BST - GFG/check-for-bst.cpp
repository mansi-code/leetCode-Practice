...
class Solution
{
    ...
    int minimum(Node* root){
        ...
        return min(minLeft, min(minRight, root->data));
    }
    public:
    ...
    bool isBST(Node* root) 
    {
        ...
        if(root==NULL)
            return true;
        bool checkLeft= isBST(root->left) && (maximum(root->left)<root->data);
        bool checkRight= isBST(root->right)&&(minimum(root->right)> root->data );
